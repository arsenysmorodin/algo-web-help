<template>
  <div class="navbar bg-base-100">
    ...
    <div class="navbar-end">
      <a href="https://github.com/arsenysmorodin">
        <svg
          width="32px"
          height="32px"
          viewBox="0 0 24 24"
...
const menuItems = [
  {
    ...
    url: '/html',
    sublinks: [
      { label: 'Теги', url: '/html/tags' },
      { label: 'Структура страницы', url: '/html/page-example' },
      { label: 'Best Practises', url: '/html/best-practises' }
    ]
  },
  {
    label: 'CSS',
    url: '/css',
    sublinks: [
      { label: 'Правила', url: '/css/rules' },
      { label: 'Готовые классы', url: '/css/ready-to-use-classes' },
      { label: 'Best Practises', url: '/css/best-practises' }
    ]
  },
  {
    label: 'JS',
    url: '/js',
    sublinks: [
      { label: 'Синтаксис', url: '/js/syntax' },
      { label: 'Best Practises', url: '/js/best-practises' }
    ]
  },
  { label: '🛠 Как сделать...', url: '/recipies' },
  { label: '👀 Полезные ссылки', url: '/link' },
  { label: '🚀 Что дальше?', url: '/forward' }
]
</script>
